...
export const AllowedContractAllowance = {
  ...
  fromJSON(object: any): AllowedContractAllowance {
    return {
      ...
      allowedAddress: Array.isArray(object?.allowedAddress)
        ? object.allowedAddress.map((e: any) => String(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<AllowedContractAllowance>, I>>(
    object: I,
